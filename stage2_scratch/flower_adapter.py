...
Uses the same:
- Model builder: create_mobilenetv3_stage1(num_classes, pretrained=False)
- Dataset loaders and transforms
- Client training function and optimizer (SGD Algorithm 1 or AdamW)
- Exact weighted aggregation math for parameters and BatchNorm buffers
- Single global validation per round at server
"""
...
class FlowerPlantClient(fl.client.NumPyClient):
