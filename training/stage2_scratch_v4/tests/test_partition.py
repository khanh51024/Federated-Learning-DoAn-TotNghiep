...
if not REAL_DATASET.exists():
    for cand in [
        ROOT.parents[1] / "training-data/stage2/PlantVillage-Dataset/raw/color",
        ROOT.parents[1] / "dataset/PlantVillage-Dataset/raw/color",
        ROOT.parents[1] / "train-gd-2/PlantVillage-Dataset/raw/color",
    ]:
        if cand.exists():
            REAL_DATASET = cand
            break
...
if not REAL_LEAF_MAP.exists():
    for cand in [
        ROOT.parents[1] / "training-data/stage2/PlantVillage-Dataset/leaf-map.json",
        ROOT.parents[1] / "dataset/PlantVillage-Dataset/leaf-map.json",
        ROOT.parents[1] / "train-gd-2/PlantVillage-Dataset/leaf-map.json",
    ]:
        if cand.exists():
            REAL_LEAF_MAP = cand
            break
